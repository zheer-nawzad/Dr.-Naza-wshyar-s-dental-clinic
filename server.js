...
const TREATMENTS = [
    ...
    { id: 4, name_en: 'Tooth Extraction', name_ku: 'لێکردنی ددان', duration: 45 },
    { id: 5, name_en: 'Root Canal', name_ku: 'دەرمانکردنی ڕەگی ددان', duration: 90 },
    { id: 6, name_en: 'Dental Crown', name_ku: 'تاجی ددان', duration: 60 },
    { id: 7, name_en: 'Teeth Whitening', name_ku: 'سپیکردنەوەی ددان', duration: 60 },
    { id: 8, name_en: 'Dental X-Ray', name_ku: 'وێنەی تیشکی ددان', duration: 15 },
    { id: 9, name_en: 'Orthodontic Consultation', name_ku: 'ڕاوێژی ڕێکخستنی ددان', duration: 45 },
    { id: 10, name_en: 'Emergency Treatment', name_ku: 'چارەسەری فریاکەوتن', duration: 30 },
    { id: 11, name_en: 'Dental Implant Consultation', name_ku: 'ڕاوێژی چاندنی ددان', duration: 60 },
    { id: 12, name_en: 'Gum Treatment', name_ku: 'چارەسەری دڵک', duration: 45 }
];
